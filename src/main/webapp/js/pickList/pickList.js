(function ($) {
   ...
   $.fn.pickList = function (options) {
      ...
      this.controll = function () {
         ...
         // update this case for your needs
         pickThis.find(".pRefresh").on('click', function () {
        	 $("tr.selected").click();
         });
      };
      ...
      this.init = function () {
         var pickListHtml =
                 ...
                 " </div>" +
                 " <div class='col s2 pickListButtons'>" +
                 ...
                 "	<button  class='pRefresh btn btn-primary btn-sm'>" + opts.refresh + "</button>" +
                 " </div>" +
                 " <div class='col s5'>" +
